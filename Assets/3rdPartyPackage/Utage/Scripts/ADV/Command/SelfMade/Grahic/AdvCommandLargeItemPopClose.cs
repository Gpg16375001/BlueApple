...
namespace Utage
{
	...
	/// <summary>
	/// 自作コマンド：大きいアイテムポップアップ閉   develop by ryo yoshida. 2018/08/07
	/// </summary>
	internal class AdvCommandLargeItemPopClose : AdvCommand
	{
		public AdvCommandLargeItemPopClose(StringGridRow row, AdvSettingDataManager dataManager)
			: base(row)
		{
		}
