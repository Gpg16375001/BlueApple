...
namespace Utage
{
	...
	public class AdvSettingDataManager
	{
        ...
        /// その他オブジェクト設定
        /// </summary>
		public AdvObjectSetting OtherObjectSetting { get { return this.advOtherObjectSetting; } }
		AdvObjectSetting advOtherObjectSetting = new AdvObjectSetting();
		...
		List<IAdvSetting> SettingDataList
		{
			get
			{
				if (settingDataList == null)
				{
					...
					settingDataList.Add(OtherObjectSetting);
				}
        ...
        public void BootInit(string rootDirResource, string assetRootDir = "")
		{
            BootSetting.BootInit(rootDirResource, assetRootDir);
