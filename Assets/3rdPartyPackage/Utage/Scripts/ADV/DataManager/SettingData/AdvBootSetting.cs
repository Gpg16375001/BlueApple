...
namespace Utage
{
	...
	public partial class AdvBootSetting
	{
		...
		/// その他オブジェクトのパス情報
        /// </summary>
		public DefaultDirInfo OtherObjectDirInfo { get { return otherObjectDirInfo; } }
		DefaultDirInfo otherObjectDirInfo;
        ...
        public void BootInit( string resourceDir, string assetRootDir = "" )
		{
			...
			otherObjectDirInfo = new DefaultDirInfo { defaultDir = @"OtherObject", defaultExt = ".prefab" };
