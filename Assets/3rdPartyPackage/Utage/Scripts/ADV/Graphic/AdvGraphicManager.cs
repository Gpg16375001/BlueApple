...
namespace Utage
{
	...
	public class AdvGraphicManager : MonoBehaviour, IBinaryIO
	{
		...
		/// <summary>
        /// キャラと背景の間に表示するスプライト関連の管理 self made by yoshida. 2018/08/01
        /// </summary>
		public AdvGraphicGroup BetweenCharaAndBgSprite { get { return this.Groups[AdvLayerSettingData.LayerType.BetweenCharaAndBG]; } }
		...
		{
			Debug.Log(layerName+" : "+(FindLayer(layerName)));
