...
namespace Utage
{
	...
	public class AdvGraphicInfo : IAssetFileSettingData
	{
		...
		public const string TypeOtherObject = "Object"; // その他オブジェクト. self made by yoshida. 2018/07/31
		...
		public const string FileTypeOtherObject = "OtherObject";
		...
		public AdvGraphicInfo( string dataType, int index, string key, StringGridRow row, IAdvSettingData advSettindData )
		{
			...
			switch (DataType)
			{
				case AdvGraphicInfo.TypeParticle:
					...
					break;
				case AdvGraphicInfo.TypeOtherObject:
					this.FileType = AdvGraphicInfo.FileTypeOtherObject;               
					break;
				default:
	...
	public void BootInit( Func<string,string, string> FileNameToPath, AdvSettingDataManager dataManager)
		...
		internal Type GetComponentType()
		{
			...
			switch (this.FileType)
			{
				...
				case FileTypeOtherObject:
					return typeof(AdvGraphicOtherObject);
				case FileTypeCustom:
		...
		public static AdvGraphicInfo ReadGraphicInfo(AdvEngine engine, BinaryReader reader)
		{
			...
			switch (dataType)
			{
				...
				case TypeOtherObject:
					return engine.DataManager.SettingDataManager.OtherObjectSetting.LabelToGraphic(key);
				case TypeTexture:
