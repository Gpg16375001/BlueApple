...
{
	[MessagePackFormatter(typeof(ReceivePresentboxGetReceivableListFormatter))]
	public partial class ReceivePresentboxGetReceivableList : BaseReceiveAPI
	{
		// response
		public PresentData[] PresentDataList;
		public int ReceivablePresentCount;

		class ReceivePresentboxGetReceivableListFormatter : IMessagePackFormatter<ReceivePresentboxGetReceivableList>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceivePresentboxGetReceivableList value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceivePresentboxGetReceivableList Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceivePresentboxGetReceivableList ret = new ReceivePresentboxGetReceivableList();
