...
{
	[MessagePackFormatter(typeof(ReceiveUsersHealBattlePointWithGemFormatter))]
	public partial class ReceiveUsersHealBattlePointWithGem : BaseReceiveAPI
	{
		// response
		public PvpUserData PvpUserData;
		public UserData UserData;

		class ReceiveUsersHealBattlePointWithGemFormatter : IMessagePackFormatter<ReceiveUsersHealBattlePointWithGem>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersHealBattlePointWithGem value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersHealBattlePointWithGem Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersHealBattlePointWithGem ret = new ReceiveUsersHealBattlePointWithGem();
