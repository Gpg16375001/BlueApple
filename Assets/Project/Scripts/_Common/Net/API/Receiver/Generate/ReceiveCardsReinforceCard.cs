...
{
	[MessagePackFormatter(typeof(ReceiveCardsReinforceCardFormatter))]
	public partial class ReceiveCardsReinforceCard : BaseReceiveAPI
	{
		// response
		...
		class ReceiveCardsReinforceCardFormatter : IMessagePackFormatter<ReceiveCardsReinforceCard>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsReinforceCard value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsReinforceCard Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsReinforceCard ret = new ReceiveCardsReinforceCard();
