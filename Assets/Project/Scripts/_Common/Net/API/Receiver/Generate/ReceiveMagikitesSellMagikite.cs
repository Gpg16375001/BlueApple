...
{
	[MessagePackFormatter(typeof(ReceiveMagikitesSellMagikiteFormatter))]
	public partial class ReceiveMagikitesSellMagikite : BaseReceiveAPI
	{
		// response
		public UserData UserData;

		class ReceiveMagikitesSellMagikiteFormatter : IMessagePackFormatter<ReceiveMagikitesSellMagikite>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveMagikitesSellMagikite value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveMagikitesSellMagikite Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveMagikitesSellMagikite ret = new ReceiveMagikitesSellMagikite();
