...
{
	[MessagePackFormatter(typeof(ReceiveUsersGetBattleSupporterListFormatter))]
	public partial class ReceiveUsersGetBattleSupporterList : BaseReceiveAPI
	{
		// response
		public UserData[] UserDataList;

		class ReceiveUsersGetBattleSupporterListFormatter : IMessagePackFormatter<ReceiveUsersGetBattleSupporterList>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersGetBattleSupporterList value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersGetBattleSupporterList Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersGetBattleSupporterList ret = new ReceiveUsersGetBattleSupporterList();
