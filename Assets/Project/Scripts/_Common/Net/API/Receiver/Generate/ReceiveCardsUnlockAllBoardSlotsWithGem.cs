...
{
	[MessagePackFormatter(typeof(ReceiveCardsUnlockAllBoardSlotsWithGemFormatter))]
	public partial class ReceiveCardsUnlockAllBoardSlotsWithGem : BaseReceiveAPI
	{
		// response
		public CardData CardData;
		public UserData UserData;

		class ReceiveCardsUnlockAllBoardSlotsWithGemFormatter : IMessagePackFormatter<ReceiveCardsUnlockAllBoardSlotsWithGem>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsUnlockAllBoardSlotsWithGem value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsUnlockAllBoardSlotsWithGem Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsUnlockAllBoardSlotsWithGem ret = new ReceiveCardsUnlockAllBoardSlotsWithGem();
