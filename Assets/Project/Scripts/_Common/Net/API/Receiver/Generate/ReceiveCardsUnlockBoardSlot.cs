...
{
	[MessagePackFormatter(typeof(ReceiveCardsUnlockBoardSlotFormatter))]
	public partial class ReceiveCardsUnlockBoardSlot : BaseReceiveAPI
	{
		// response
		public CardData CardData;
		public UserData UserData;

		class ReceiveCardsUnlockBoardSlotFormatter : IMessagePackFormatter<ReceiveCardsUnlockBoardSlot>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsUnlockBoardSlot value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsUnlockBoardSlot Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsUnlockBoardSlot ret = new ReceiveCardsUnlockBoardSlot();
