...
{
	[MessagePackFormatter(typeof(ReceivePaymentsSubmitReceiptWithTimeoutFormatter))]
	public partial class ReceivePaymentsSubmitReceiptWithTimeout : BaseReceiveAPI
	{
		// response
		public UserData UserData;

		class ReceivePaymentsSubmitReceiptWithTimeoutFormatter : IMessagePackFormatter<ReceivePaymentsSubmitReceiptWithTimeout>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceivePaymentsSubmitReceiptWithTimeout value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceivePaymentsSubmitReceiptWithTimeout Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceivePaymentsSubmitReceiptWithTimeout ret = new ReceivePaymentsSubmitReceiptWithTimeout();
