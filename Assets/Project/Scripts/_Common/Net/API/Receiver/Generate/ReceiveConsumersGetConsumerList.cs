...
{
	[MessagePackFormatter(typeof(ReceiveConsumersGetConsumerListFormatter))]
	public partial class ReceiveConsumersGetConsumerList : BaseReceiveAPI
	{
		// response
		public ConsumerData[] ConsumerDataList;

		class ReceiveConsumersGetConsumerListFormatter : IMessagePackFormatter<ReceiveConsumersGetConsumerList>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveConsumersGetConsumerList value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveConsumersGetConsumerList Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveConsumersGetConsumerList ret = new ReceiveConsumersGetConsumerList();
