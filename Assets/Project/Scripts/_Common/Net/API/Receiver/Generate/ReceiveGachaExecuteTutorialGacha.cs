...
{
	[MessagePackFormatter(typeof(ReceiveGachaExecuteTutorialGachaFormatter))]
	public partial class ReceiveGachaExecuteTutorialGacha : BaseReceiveAPI
	{
		// response
		public AcquiredGachaItemData[] AcquiredGachaItemDataList;
		public UserData UserData;

		class ReceiveGachaExecuteTutorialGachaFormatter : IMessagePackFormatter<ReceiveGachaExecuteTutorialGacha>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveGachaExecuteTutorialGacha value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveGachaExecuteTutorialGacha Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveGachaExecuteTutorialGacha ret = new ReceiveGachaExecuteTutorialGacha();
