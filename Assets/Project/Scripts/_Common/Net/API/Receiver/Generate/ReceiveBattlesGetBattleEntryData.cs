...
{
	[MessagePackFormatter(typeof(ReceiveBattlesGetBattleEntryDataFormatter))]
	public partial class ReceiveBattlesGetBattleEntryData : BaseReceiveAPI
	{
		// response
		public BattleEntryData BattleEntryData;

		class ReceiveBattlesGetBattleEntryDataFormatter : IMessagePackFormatter<ReceiveBattlesGetBattleEntryData>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveBattlesGetBattleEntryData value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveBattlesGetBattleEntryData Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveBattlesGetBattleEntryData ret = new ReceiveBattlesGetBattleEntryData();
