...
{
	[MessagePackFormatter(typeof(ReceiveCardsUnlockBoardSlotWithGemFormatter))]
	public partial class ReceiveCardsUnlockBoardSlotWithGem : BaseReceiveAPI
	{
		// response
		public CardData CardData;
		public UserData UserData;

		class ReceiveCardsUnlockBoardSlotWithGemFormatter : IMessagePackFormatter<ReceiveCardsUnlockBoardSlotWithGem>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsUnlockBoardSlotWithGem value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsUnlockBoardSlotWithGem Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsUnlockBoardSlotWithGem ret = new ReceiveCardsUnlockBoardSlotWithGem();
