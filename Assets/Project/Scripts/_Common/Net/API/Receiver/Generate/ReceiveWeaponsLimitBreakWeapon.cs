...
{
	[MessagePackFormatter(typeof(ReceiveWeaponsLimitBreakWeaponFormatter))]
	public partial class ReceiveWeaponsLimitBreakWeapon : BaseReceiveAPI
	{
		// response
		public WeaponData WeaponData;
		public UserData UserData;

		class ReceiveWeaponsLimitBreakWeaponFormatter : IMessagePackFormatter<ReceiveWeaponsLimitBreakWeapon>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveWeaponsLimitBreakWeapon value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveWeaponsLimitBreakWeapon Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveWeaponsLimitBreakWeapon ret = new ReceiveWeaponsLimitBreakWeapon();
