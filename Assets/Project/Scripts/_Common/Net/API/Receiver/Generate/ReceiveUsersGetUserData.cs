...
{
	[MessagePackFormatter(typeof(ReceiveUsersGetUserDataFormatter))]
	public partial class ReceiveUsersGetUserData : BaseReceiveAPI
	{
		// response
		public UserData[] UserDataList;

		class ReceiveUsersGetUserDataFormatter : IMessagePackFormatter<ReceiveUsersGetUserData>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersGetUserData value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersGetUserData Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersGetUserData ret = new ReceiveUsersGetUserData();
