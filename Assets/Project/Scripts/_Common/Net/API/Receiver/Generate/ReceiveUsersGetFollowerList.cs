...
{
	[MessagePackFormatter(typeof(ReceiveUsersGetFollowerListFormatter))]
	public partial class ReceiveUsersGetFollowerList : BaseReceiveAPI
	{
		// response
		public UserData[] UserDataList;

		class ReceiveUsersGetFollowerListFormatter : IMessagePackFormatter<ReceiveUsersGetFollowerList>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersGetFollowerList value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersGetFollowerList Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersGetFollowerList ret = new ReceiveUsersGetFollowerList();
