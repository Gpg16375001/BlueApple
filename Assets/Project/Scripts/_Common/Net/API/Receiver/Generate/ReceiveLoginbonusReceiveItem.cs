...
{
	[MessagePackFormatter(typeof(ReceiveLoginbonusReceiveItemFormatter))]
	public partial class ReceiveLoginbonusReceiveItem : BaseReceiveAPI
	{
		// response
		public LoginbonusData[] LoginbonusDataList;

		class ReceiveLoginbonusReceiveItemFormatter : IMessagePackFormatter<ReceiveLoginbonusReceiveItem>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveLoginbonusReceiveItem value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveLoginbonusReceiveItem Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveLoginbonusReceiveItem ret = new ReceiveLoginbonusReceiveItem();
