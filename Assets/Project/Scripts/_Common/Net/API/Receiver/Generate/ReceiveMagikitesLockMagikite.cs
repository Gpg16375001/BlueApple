...
{
	[MessagePackFormatter(typeof(ReceiveMagikitesLockMagikiteFormatter))]
	public partial class ReceiveMagikitesLockMagikite : BaseReceiveAPI
	{
		// response
		public MagikiteData MagikiteData;

		class ReceiveMagikitesLockMagikiteFormatter : IMessagePackFormatter<ReceiveMagikitesLockMagikite>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveMagikitesLockMagikite value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveMagikitesLockMagikite Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveMagikitesLockMagikite ret = new ReceiveMagikitesLockMagikite();
