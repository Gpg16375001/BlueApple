...
{
	[MessagePackFormatter(typeof(ReceiveUsersSearchByCustomerIdFormatter))]
	public partial class ReceiveUsersSearchByCustomerId : BaseReceiveAPI
	{
		// response
		public UserData[] UserDataList;

		class ReceiveUsersSearchByCustomerIdFormatter : IMessagePackFormatter<ReceiveUsersSearchByCustomerId>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersSearchByCustomerId value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersSearchByCustomerId Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersSearchByCustomerId ret = new ReceiveUsersSearchByCustomerId();
