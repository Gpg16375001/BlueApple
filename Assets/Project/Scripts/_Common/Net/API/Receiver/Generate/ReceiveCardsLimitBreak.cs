...
{
	[MessagePackFormatter(typeof(ReceiveCardsLimitBreakFormatter))]
	public partial class ReceiveCardsLimitBreak : BaseReceiveAPI
	{
		// response
		public CardData CardData;
		public UserData UserData;

		class ReceiveCardsLimitBreakFormatter : IMessagePackFormatter<ReceiveCardsLimitBreak>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsLimitBreak value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsLimitBreak Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsLimitBreak ret = new ReceiveCardsLimitBreak();
