...
{
	[MessagePackFormatter(typeof(ReceiveQuestsGetAchievementByQuestIdFormatter))]
	public partial class ReceiveQuestsGetAchievementByQuestId : BaseReceiveAPI
	{
		// response
		public bool IsAchieved;

		class ReceiveQuestsGetAchievementByQuestIdFormatter : IMessagePackFormatter<ReceiveQuestsGetAchievementByQuestId>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveQuestsGetAchievementByQuestId value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveQuestsGetAchievementByQuestId Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveQuestsGetAchievementByQuestId ret = new ReceiveQuestsGetAchievementByQuestId();
