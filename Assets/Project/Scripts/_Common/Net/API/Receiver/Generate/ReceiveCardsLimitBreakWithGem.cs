...
{
	[MessagePackFormatter(typeof(ReceiveCardsLimitBreakWithGemFormatter))]
	public partial class ReceiveCardsLimitBreakWithGem : BaseReceiveAPI
	{
		// response
		public CardData CardData;
		public UserData UserData;

		class ReceiveCardsLimitBreakWithGemFormatter : IMessagePackFormatter<ReceiveCardsLimitBreakWithGem>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsLimitBreakWithGem value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsLimitBreakWithGem Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsLimitBreakWithGem ret = new ReceiveCardsLimitBreakWithGem();
