...
{
	[MessagePackFormatter(typeof(ReceiveQuestsGetAchievementFormatter))]
	public partial class ReceiveQuestsGetAchievement : BaseReceiveAPI
	{
		// response
		public QuestAchievement[] QuestAchievementList;

		class ReceiveQuestsGetAchievementFormatter : IMessagePackFormatter<ReceiveQuestsGetAchievement>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveQuestsGetAchievement value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveQuestsGetAchievement Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveQuestsGetAchievement ret = new ReceiveQuestsGetAchievement();
