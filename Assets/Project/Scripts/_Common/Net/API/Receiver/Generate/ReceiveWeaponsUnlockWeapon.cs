...
{
	[MessagePackFormatter(typeof(ReceiveWeaponsUnlockWeaponFormatter))]
	public partial class ReceiveWeaponsUnlockWeapon : BaseReceiveAPI
	{
		// response
		public WeaponData WeaponData;

		class ReceiveWeaponsUnlockWeaponFormatter : IMessagePackFormatter<ReceiveWeaponsUnlockWeapon>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveWeaponsUnlockWeapon value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveWeaponsUnlockWeapon Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveWeaponsUnlockWeapon ret = new ReceiveWeaponsUnlockWeapon();
