...
{
	[MessagePackFormatter(typeof(ReceiveQuestsGetAchievementByTypeFormatter))]
	public partial class ReceiveQuestsGetAchievementByType : BaseReceiveAPI
	{
		// response
		public QuestAchievement[] QuestAchievementList;

		class ReceiveQuestsGetAchievementByTypeFormatter : IMessagePackFormatter<ReceiveQuestsGetAchievementByType>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveQuestsGetAchievementByType value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveQuestsGetAchievementByType Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveQuestsGetAchievementByType ret = new ReceiveQuestsGetAchievementByType();
