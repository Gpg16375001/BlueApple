...
{
	[MessagePackFormatter(typeof(ReceiveUsersRemoveFollowerFormatter))]
	public partial class ReceiveUsersRemoveFollower : BaseReceiveAPI
	{
		// response


		class ReceiveUsersRemoveFollowerFormatter : IMessagePackFormatter<ReceiveUsersRemoveFollower>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersRemoveFollower value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersRemoveFollower Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersRemoveFollower ret = new ReceiveUsersRemoveFollower();
