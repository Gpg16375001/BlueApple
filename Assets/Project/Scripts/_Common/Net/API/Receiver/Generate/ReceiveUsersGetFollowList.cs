...
{
	[MessagePackFormatter(typeof(ReceiveUsersGetFollowListFormatter))]
	public partial class ReceiveUsersGetFollowList : BaseReceiveAPI
	{
		// response
		public UserData[] UserDataList;

		class ReceiveUsersGetFollowListFormatter : IMessagePackFormatter<ReceiveUsersGetFollowList>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveUsersGetFollowList value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveUsersGetFollowList Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveUsersGetFollowList ret = new ReceiveUsersGetFollowList();
