...
{
	[MessagePackFormatter(typeof(ReceivePresentboxReceiveItemFormatter))]
	public partial class ReceivePresentboxReceiveItem : BaseReceiveAPI
	{
		// response
		...
		class ReceivePresentboxReceiveItemFormatter : IMessagePackFormatter<ReceivePresentboxReceiveItem>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceivePresentboxReceiveItem value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceivePresentboxReceiveItem Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceivePresentboxReceiveItem ret = new ReceivePresentboxReceiveItem();
