...
{
	[MessagePackFormatter(typeof(ReceiveFriendsGetFollowerListFormatter))]
	public partial class ReceiveFriendsGetFollowerList : BaseReceiveAPI
	{
		// response
		public FriendData[] FriendDataList;

		class ReceiveFriendsGetFollowerListFormatter : IMessagePackFormatter<ReceiveFriendsGetFollowerList>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveFriendsGetFollowerList value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveFriendsGetFollowerList Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveFriendsGetFollowerList ret = new ReceiveFriendsGetFollowerList();
