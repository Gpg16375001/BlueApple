...
{
	[MessagePackFormatter(typeof(ReceiveCardsEvolveCardFormatter))]
	public partial class ReceiveCardsEvolveCard : BaseReceiveAPI
	{
		// response
		public CardData CardData;
		public UserData UserData;

		class ReceiveCardsEvolveCardFormatter : IMessagePackFormatter<ReceiveCardsEvolveCard>
		{
			public int Serialize(ref byte[] bytes, int offset, ReceiveCardsEvolveCard value, IFormatterResolver formatterResolver) {
				if (value == null) {
			...
			public ReceiveCardsEvolveCard Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize) {
				...
				int readed = 0;
				var startOffset = offset;
				ReceiveCardsEvolveCard ret = new ReceiveCardsEvolveCard();
