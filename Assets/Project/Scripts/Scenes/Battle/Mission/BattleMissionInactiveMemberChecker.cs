...
/// <summary>
/// BattleMissionChecker : 死亡メンバー関連
/// </summary>
public class BattleMissionInactiveMemberChecker : IBattleMissionChecker
{
    /// <summary>
    ...
    public void UpdateProgress(BattleMissionProgressData data)
    {
        ...
        if(m_limitCount <= 0){
            ...
            m_bAchived = data.CharaDeadCount <= m_limitCount;
        }
    }

    /// <summary>初期化.</summary>
    public BattleMissionInactiveMemberChecker(BattleMissionConditionDefine defineInfo, bool bAlreadyAchived = false)
    {
    ...
    public BattleMissionInactiveMemberChecker(BattleMissionConditionDefine defineInfo, int limit, bool bAlreadyAchived = false)
    {
