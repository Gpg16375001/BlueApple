...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:0,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:False,mssp:True,bkdf:False,hqlp:False,rprd:True,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:0,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:0,x:34496,y:32292,varname:node_0,prsc:2|emission-825-RGB,alpha-4715-OUT,refract-5866-OUT;n:type:ShaderForge.SFN_Slider,id:13,x:33818,y:32832,ptovrint:False,ptlb:Refraction Intensity,ptin:_RefractionIntensity,varname:_RefractionIntensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-4,cur:1,max:4;n:type:ShaderForge.SFN_Multiply,id:14,x:34155,y:32592,varname:node_14,prsc:2|A-25-R,B-13-OUT,C-4847-A;n:type:ShaderForge.SFN_Tex2d,id:25,x:33975,y:32592,ptovrint:False,ptlb:NormalMap,ptin:_NormalMap,varname:_NormalMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:630f164e44edb4d848a0fc4d010cfb42,ntxv:3,isnm:True|UVIN-26-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:26,x:33818,y:32592,varname:node_26,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Vector1,id:4715,x:34321,y:32525,varname:node_4715,prsc:2,v1:0;n:type:ShaderForge.SFN_VertexColor,id:4847,x:33975,y:32971,varname:node_4847,prsc:2;n:type:ShaderForge.SFN_Multiply,id:854,x:34155,y:32832,varname:node_854,prsc:2|A-25-G,B-13-OUT,C-4847-A;n:type:ShaderForge.SFN_Append,id:5866,x:34321,y:32592,varname:node_5866,prsc:2|A-14-OUT,B-854-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:1328,x:33627,y:32392,varname:node_1328,prsc:2;n:type:ShaderForge.SFN_SceneColor,id:825,x:34321,y:32392,varname:node_825,prsc:2|UVIN-6384-OUT;n:type:ShaderForge.SFN_Code,id:6384,x:33818,y:32392,varname:node_6384,prsc:2,code:,output:1,fname:GetGrabUVWithUnityMacro,width:438,height:132,input:2,input_1_label:WorldPos|A-1328-XYZ;proporder:13-25;pass:END;sub:END;*/

Shader "Effects/NormalDistortion" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float2 GetGrabUVWithUnityMacro( float3 WorldPos ){
...
////// Lighting:
////// Emissive:
                float3 emissive = tex2D( _GrabTexture, GetGrabUVWithUnityMacro( i.posWorld.rgb )).rgb;
